...
:::finding Hinweis
Mit dem `0b` zu Beginn zeigt Python an, dass es sich um eine Binärzahl handelt. Analog zu der [Subskript-Schreibweise](05-Zeichencodierung.mdx#hinweis-subskript) $1000001_2$ schreibt Python `0b1000001`.
:::
::::
